<meta property="og:site_name" content="{{ $page->siteName }}" />
    ...
    <meta property="og:image" content="{{ $page->getUrl() }}{{ $page->og['image'] ?? $page->cover_image }}" />
...
@endforeach
    ...
    <meta name="twitter:image" content="{{ $page->getUrl() }}{{ $page->twitter['image'] ?? $page->cover_image }}" />
